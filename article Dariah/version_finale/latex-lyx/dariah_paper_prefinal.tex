...
une préface de M. Henry Bordeaux}, Paris, Georges Crès \& Cie, 1904. }. Moreover, he has been honored by several awards and was in contact
...
(accessed 14 September 2018).}, its Viaf entity\footnote{\href{https://viaf.org/viaf/24623115}{https://viaf.org/viaf/24623115}(accessed
...
page\footnote{\href{http://dbpedia.org/page/Henri_Carton_de_Wiart}{http://dbpedia.org/page/Henri\_{}Carton\_{}de\_{}Wiart}
...
the loss of information, which in turn renders it difficult to deliver
...
persons. Again, we have noticed some limits related to granularity.
...
and have uncle and cousin described by the same vague property. 
\item For social relationship, the vocabulary \textsf{\textsc{BIO:relationship}}\footnote{\href{https://lov.linkeddata.es/dataset/lov/vocabs/bio}{https://lov.linkeddata.es/dataset/lov/vocabs/bio}
...
useful, sometimes it appears quite difficult to evaluate the specific
